...
type RequestLog struct {
	...
	CostMicrousd      int64   `json:"costMicrousd" gorm:"comment:估算成本，单位微美元"`
	CostAmount        float64 `json:"costAmount" gorm:"-"`
	PricingMatched    bool    `json:"pricingMatched" gorm:"index;comment:是否匹配官方定价"`
	PricingSource     string  `json:"pricingSource" gorm:"size:50;comment:定价来源"`
